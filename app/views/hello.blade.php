    ...
    <div class="overlay progress-overlay">
      ...
      <div class="share">
        ...
        <div class="share-btn-wrapper">
          <button class="share-btn"><a href="https://twitter.com/home?status=insert the copy here for tweet" target="_blank"><img src="img/twitter.svg"></a><a href="#" onclick="fbShare('http://brightenup.sew.la', 'BrightPink Assessment', '1 in 8 women will develop breast cancer at some point in her lifetime. 1 in 67 will develop ovarian cancer.', 'http://brightenup.sew.la/img/brightpink_logo.png', 520, 350)"><img src="img/facebook.svg"></a><a href="#" onclick="shareMail();"><img src="img/mail.svg"></a>SHARE</button>
        </div>
      </div>
      <div class="vignettes">
        ...
        <div class="paragraph-wrapper">
          ...
          <!-- Increased (Moderate) -->
            ...
            <div class="results-copy-high">
              ...
              <div class="column">  
                <h3 class="column-header">Understanding Your Baseline Risk</h3>
                <p>Your answers suggest that you are at a <a href="">high baseline risk</a> for breast and ovarian cancer, due either to a diagnosed gene mutation associated with one of these cancers or, if you’ve not yet undergone genetic testing yourself, having a 1st degree relative who has been diagnosed with one of these mutations.
                <span class="more-results">Being at high-risk means that you have up to an 87% chance of getting breast cancer and up to a 54% chance of getting ovarian cancer.  
              ...
              <div class="column">
                ...
                <p class="more-results"><i>If you’ve not yet had genetic testing</i>, we suggest you seek input from an OB/GYN or a genetic counselor, to discuss whether you’re a candidate as well as what the process entails.  
      ...
      <div class="assessment-wrap">
       ...
       <div class="question" data-question-id="16">
        ...
        <div class="share">
          ...
          <h4 class="save-share">Save the life of somebody you love. Tell them to complete this experience too.</h4><button class="share-btn"><a href="https://twitter.com/home?status=insert the copy here for tweet" target="_blank"><img src="img/twitter.svg"></a><a href="#" onclick="fbShare('http://brightenup.sew.la', 'BrightPink Assessment', '1 in 8 women will develop breast cancer at some point in her lifetime. 1 in 67 will develop ovarian cancer.', 'http://brightenup.sew.la/img/brightpink_logo.png', 520, 350)"><img src="img/facebook.svg"></a><a href="#" onclick="shareMail();"><img src="img/mail.svg"></a>SHARE</button>
        </div>
      </div>
    </section>
