...
<!-- LIFESTYLE -->
      ...
      <div class="module lifestyle">
        ...
        <div class="vignette">
          <div class="video">
            <video class="bg-video" src="video/running.mov" type="video/mov" loop></video>
          </div>
          <div class="headlines">
            <div class="headline">         
        ...
        <div class="vignette">
          <div class="video">
            <video class="bg-video" src="video/fat.mov" type="video/mov" loop></video>
          </div>
          <div class="headlines">
            <div class="headline">         
        ...
        <div class="vignette">
          <div class="video">
            <video class="bg-video" src="video/alcohol.mov" type="video/mov" loop></video>
          </div>
          <div class="headlines">
            <div class="headline">         
        ...
        <div class="vignette">
          <div class="video">
            <video class="bg-video" src="video/smoking.mov" type="video/mov" loop></video>
          </div>
          <div class="headlines">
            <div class="headline">         
        ...
        <div class="vignette">
          <div class="video">
            <video class="bg-video" src="video/birthControl.mov" type="video/mov" loop></video>
          </div>
          <div class="headlines">
            <div class="headline">         
...
<!-- KNOW YOUR NORMAL -->
      ...
      <div class="module normal">
        ...
        <div class="vignette">
          <div class="video">
            <video class="bg-video" src="video/breastAwareness.mov" type="video/mov" loop></video>
          </div>
          <div class="headlines">
            <div class="headline">         
...
<!-- FAMILY HISTORY -->
      ...
      <div class="module family-history">
        ...
        <div class="vignette">
          <div class="video">
            <video class="bg-video" src="video/family.mov" type="video/mov" loop></video>
          </div>
          <div class="headlines">
            <div class="headline">         
        ...
        <div class="vignette">
          <div class="video">
            <video class="bg-video" src="video/mother.mov" type="video/mov" loop></video>
          </div>
          <div class="headlines">
            <div class="headline">
