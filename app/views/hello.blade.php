...
<!--[if gt IE 8]><!--> <html class=""> <!--<![endif]-->
  ...
  <body>
    ...
    <div class="overlay male-overlay">
      ...
      <h1>Then <span class="share-btn">share<a href="https://twitter.com/intent/tweet?text=Check+out+Bright+Pink%27s+%23AssessYourRisk+tool+to+assess+and+reduce+your+risk+for+breast+and+ovarian+cancer.+AssessYourRisk.org" target="_blank"><img src="img/twitter.png"></a><a href="#/assessment" onclick="fb_share('http://www.assessyourrisk.org', 'Assess Your Risk', '1 in 8 women will develop breast cancer in their lifetime. 1 in 67 will develop ovarian cancer. Bright Pink created a tool to help you assess your personal level of risk for breast and ovarian cancer and reduce your chances of being that 1. Learn more and #AssessYourRisk!', 'http://www.assessyourrisk.org/img/ayr_logo_bp.png', 520, 350)"><img src="img/facebook.png"></a><a href="mailto:name@email.com?subject=Bright Pink Risk Assessment: 5 Minutes Could Save Your Life&body=Hi, 
%0D%0A
%0D%0A
    ...
    <div class="overlay menu-overlay">
      ...
      <div class="share">
        ...
        <div class="share-btn-wrapper">
          <button class="share-btn"><a href="https://twitter.com/intent/tweet?text=Check+out+Bright+Pink%27s+%23AssessYourRisk+tool+to+assess+and+reduce+your+risk+for+breast+and+ovarian+cancer.+AssessYourRisk.org" target="_blank"><img src="img/twitter.png"></a><a href="#/assessment" onclick="fb_share('http://brightenup.sew.la', 'BrightPink Assessment', '1 in 8 women will develop breast cancer in their lifetime. 1 in 67 will develop ovarian cancer. Bright Pink created a tool to help you assess you personal level of risk for breast and ovarian cancer and reduce your chances of being that 1. Learn more and #AssessYourRisk!', 'http://brightenup.sew.la/img/brightpink_logo.png', 520, 350)"><img src="img/facebook.png"></a><a href="mailto:name@email.com?subject=Bright Pink Risk Assessment: 5 Minutes Could Save Your Life&body=Hi, 
%0D%0A
%0D%0A
I want to share something important with you. 
%0D%0A
...
<!--           <div class="progress-result">
        ...
        <!-- Pink Email/PDF/Doctor Footer on first card -->
            <div class="email-pdf-doctor">
              <!-- <div class="email-pdf"><a href='mailto:name@email.com?subject=Here are the results of my risk assessment&amp;body=I thought you might find this information interesting' target="_blank">Email to your Doctor</a> -->
      ...
      <div class="assessment-wrap">
        ...
        <div class="question" data-question-id="14">
          ...
          <div class="answers">
            ...
            <a href="mailto:name@email.com?subject=Can you help me answer this%3F&body=Hello, 
%0D%0A
%0D%0A
...
%0D%0A
%0D%0A
Do you know if anybody in the family has been diagnosed with any of these%3F" target="_blank"><button class="sub ask">Help me ask them</button></a>
          </div>        
        </div>
...
%0D%0A
%0D%0A
Do you know if I do%3F" target="_blank"><button class="sub ask" data-answer-id="3">Help me ask them</button></a>
          </div>
        </div>
        ...
        <div class="share">
          ...
          <h4 class="save-share">Save the life of somebody you love. Tell them to complete this experience too.</h4><button class="share-btn"><a href="https://twitter.com/intent/tweet?text=Check+out+Bright+Pink%27s+%23AssessYourRisk+tool+to+assess+and+reduce+your+risk+for+breast+and+ovarian+cancer.+http%3A%2F%2FAssessYourRisk.org" target="_blank"><img src="img/twitter.png"></a><a href="#/assessment" onclick="fb_share('http://brightenup.sew.la', 'BrightPink Assessment', '1 in 8 women will develop breast cancer in their lifetime. 1 in 67 will develop ovarian cancer. Bright Pink created a tool to help you assess you personal level of risk for breast and ovarian cancer and reduce your chances of being that 1. Learn more and #AssessYourRisk!', 'http://brightenup.sew.la/img/brightpink_logo.png', 520, 350)"><img src="img/facebook.png"></a><a href="mailto:name@email.com?subject=Bright Pink Risk Assessment: 5 Minutes Could Save Your Life&body=Hi, 
%0D%0A
%0D%0A
I want to share something important with you. 
%0D%0A
          ...
          <div class="headlines">
            ...
            <div class="headline last">            
              <div class="share">
                ...
                <br>
                <button class="share-btn"><a href="https://twitter.com/intent/tweet?text=Check+out+Bright+Pink%27s+%23AssessYourRisk+tool+to+assess+and+reduce+your+risk+for+breast+and+ovarian+cancer.+http%3A%2F%2FAssessYourRisk.org" target="_blank"><img src="img/twitter.png"></a><a href="#/education" onclick="fb_share('http://brightenup.sew.la', 'BrightPink Assessment', '1 in 8 women will develop breast cancer at some point in her lifetime. 1 in 67 will develop ovarian cancer.', 'http://brightenup.sew.la/img/brightpink_logo.png', 520, 350)"><img src="img/facebook.png"></a><a href="mailto:name@email.com?subject=Bright Pink Risk Assessment: 5 Minutes Could Save Your Life&body=Hi, 
%0D%0A
%0D%0A
I want to share something important with you. 
%0D%0A
